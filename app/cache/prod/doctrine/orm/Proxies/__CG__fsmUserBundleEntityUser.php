...
namespace Proxies\__CG__\fsm\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \fsm\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'fsm\\UserBundle\\Entity\\User' . "\0" . 'photos', 'id', 'telephone', 'habilite', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setHabilite($habilite)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHabilite', array($habilite));

        return parent::setHabilite($habilite);
    }
    ...
    public function getHabilite()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHabilite', array());

        return parent::getHabilite();
    }
